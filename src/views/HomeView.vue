      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 w-full max-w-7xl">
        ...
        <div data-aos="fade-right" data-aos-duration="800"
          ...
          <div>
            ...
            <a :href="'https://wa.me/6287887073476?text=Halo%20saya%20mau%20pesan%20Paket%201'" target="_blank">
        ...
        <div data-aos="fade-right" data-aos-duration="900"
          ...
          <div>
            <p class="text-xl font-bold text-yellow-700 mb-2">Rp 22.000</p>
            <a :href="'https://wa.me/6287887073476?text=Halo%20saya%20mau%20pesan%20Paket%202'" target="_blank">
              <GlobalBtn label="Pesan Sekarang" />
            </a>
          </div>
        </div>
        ...
        <div data-aos="fade-right" data-aos-duration="1000"
          ...
          <div>
            ...
            <a :href="'https://wa.me/6287887073476?text=Halo%20saya%20mau%20pesan%20Paket%203'" target="_blank">
              <GlobalBtn label="Pesan Sekarang" />
            </a>
          </div>
        </div>
        ...
        <div data-aos="fade-right" data-aos-duration="1100"
          ...
          <div>
            ...
            <a :href="'https://wa.me/6287887073476?text=Halo%20saya%20mau%20pesan%20Paket%204'" target="_blank">
              <GlobalBtn label="Pesan Sekarang" />
            </a>
          </div>
        </div>
